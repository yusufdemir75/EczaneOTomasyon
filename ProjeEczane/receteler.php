...
<a href="ekle-recete.php"<button style="float: right" type="submit" class="btn btn-primary">Reçete Ekle</button></a>
<thead>
<tr>
    <th>ID</th>
    <th>Tarih</th> 
...
<tbody>
    <?php 
        $urunsor = $baglanti->prepare("SELECT * FROM recete");
        $urunsor->execute();
        while ($uruncek = $urunsor->fetch(PDO::FETCH_ASSOC)) {
    ?>
    <tr>        
        <td><?PHP   echo $uruncek['id']?></td>
        <td><?PHP   echo $uruncek['verilen_tarih']?></td>
        <td><?PHP   echo $uruncek['ilac_id']?></td>
        <td><?PHP   echo $uruncek['miktar']?></td>
        <td><?PHP   echo $uruncek['kullanim']?></td>
  
        <td><a href="duzenle-recete.php?id=<?php echo $uruncek['id'] ?>"><button type="submit" class="btn btn-dark">Düzenle</button></a></td>
        <td><a href="islem-recete.php?recetesil&id=<?php echo $uruncek['id'] ?>"><button type="submit" class="btn btn-danger">Sil</button></td>
