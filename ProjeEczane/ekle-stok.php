...
<head>
    ...
    <title>Stok Ekleme Sayfası</title>
...
<form action="islem-stok.php" method="post" style="padding-top: 35px;">
  <div class="form-group">
    ...
    <input name="barkod" type="text" class="form-control" id="exampleInputPassword1" >
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">İlaç ID</label>
    <input name="ilac_id" type="text" class="form-control" id="exampleInputPassword1" >
  </div>
  <div class="form-group">
